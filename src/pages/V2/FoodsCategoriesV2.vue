...
<template>
  <section>
    <img src="../../assets/curveBackground.png" class="w-full rotate-180 h-[65%] fixed top-0 pointer-events-none" />
    <div class="container mx-auto py-10 px-5">
        ...
        >
          ...
          <h1
            class="relative text-center text-2xl text-white font-extrabold uppercase mb-6 viga-regular"
          >
            Order Details
          </h1>
          <div
          class="py-4 px-5 flex items-start  flex-col justify-between rounded-lg bg-white shadow-[0px_0px_50px_rgba(90,_108,_234,_0.2)] relative"
        >
            <div class="text-black font-thin text-lg viga-regular">Your branch | {{orderDetails.branch.name }}</div>
            <div class="text-black font-thin text-lg viga-regular"> Your Delivery Time | {{orderDetails.deliveryTime }}</div>
            <div class="text-green-gradient font-extrabold text-[34px] lobster-regular">{{orderDetails.food.name }}</div>
        </div>
