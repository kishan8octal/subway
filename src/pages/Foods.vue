    ...
    <section>
        ...
        <div class="p-5 z-50">
            <div class="sm:max-w-7xl mx-auto p-5 sm:p-20">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-28 gap-x-10">
                    <div 
                            ...
                            :hovered="{ scale: 1.1 }"
                           class="border bg-white border-green-600 cursor-pointer ring-2 ring-green-600 
