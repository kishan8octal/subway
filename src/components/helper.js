...
import sandwichRotisserieChicken
    from '../assets/sandwichRotisserieChicken.avif';
import sandwichUltimateBMT from '../assets/sandwichUltimateBMT.avif';
import sandwichEliteChickenBaconRanch
    from '../assets/sandwichEliteChickenBaconRanch.png';
import sandwichProSweetOnionTeriyaki
    from '../assets/sandwichProSweetOnionTeriyaki.avif';
...
import cheeseMontereyCheddarShredded
    from '../assets/cheeseMontereyCheddarShredded.avif';
...
import sauceHoneyMust_Sauce_OVERHEAD2_
    from '../assets/sauceHoneyMust_Sauce_OVERHEAD2_.avif';
...
export const selectedSandwitchItem = [
    {
        id: 1,
...
export const selectedSaladItem = [
    {
        id: 1,
        name: 'Black forest Ham',
