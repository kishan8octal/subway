<template>
  ...
  >
    ...
    <h1 class="w-3/12">
      <a href="">
        <img class="h-[50px] w-[100px] filter" src="https://subway.in/static/media/subway-logo.e7b602efa8e0c7316077.webp" />
      </a>
    </h1>
    ...
    <nav class="nav font-semibold text-lg">
      <ul class="flex items-center">
        ...
        >
          <a href="" class="">CHEESE</a>
        </li>
        <li
          class="p-4 border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500 duration-200 cursor-pointer"
        >
          <a href="" class="">VEGGIES</a>
        </li>
        <li
          class="p-4 border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500 duration-200 cursor-pointer"
        >
          <a href="" class="">SAUCES</a>
        </li>
        <li
          class="p-4 border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500 duration-200 cursor-pointer"
        >
          <a href="" class="">ADD-ONS</a>
        </li>
      </ul>
    </nav>
